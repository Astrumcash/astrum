...
const string strMessageMagic = "Astrum Signed Message:\n";
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    if(nHeight % 483840 == 0 && nHeight >= 483840)
    {
        nSubsidy = 15000 * COIN;
    }
    else if(nHeight % 120960 == 0 && nHeight >= 120960 && nHeight % 483840 != 0)
    {
        nSubsidy = 3000 * COIN;
    }
    else if(nHeight % 40320 == 0 && nHeight >= 40320 && nHeight % 483840 != 0 && nHeight % 120960 != 0)
    {
        nSubsidy = 500 * COIN;
    }
    else if(nHeight % 10080 == 0 && nHeight >= 10080 && nHeight % 483840 != 0 && nHeight % 120960 != 0 && nHeight % 40320 != 0)
    {
        nSubsidy = 100 * COIN;
    }
    else
