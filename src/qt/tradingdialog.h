...
private slots:
    ...
    QString BuyASTR(QString OrderType, double Quantity, double Rate);
    QString SellASTR(QString OrderType, double Quantity, double Rate);
